	...
	$(document).ready(function() {
		...
		function Circle() {
			...
			this.draw = function() {
				...
				self.alpha -= 0.0005;
				ctx.beginPath();
				ctx.arc(self.pos.x, self.pos.y, self.scale * 15, 1, 4  * Math.PI, false);
				ctx.fillStyle = 'rgba(255,255,180,' + self.alpha + ')';
				ctx.fill();
			};
		}
		...
		$('.video').YTPlayer({
  			videoId: '2ULsVUl_SHI', // id from youtube link example: https://www.youtube.com/watch?v=z-m5CROSNZE  
  			callback: function() {
